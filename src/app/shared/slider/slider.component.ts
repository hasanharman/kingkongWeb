...
export class SliderComponent implements OnInit {
	...
	imgs = [
		...
		{ img: 'networking seçenekler/networking-secenekleri.png', icon: 'networking seçenekler/hierarchy-55 1.svg', title: 'Networking Seçenekleri', sub: 'Kişileri taleplerine göre farklı kişilerle bir araya getirerek bilgi alışverişi olanağı sağlar.' },
